package com.rolealiu.waveview;

import java.util.Timer;
import java.util.TimerTask;

import com.rolealiu.module.ScreenModule;
...
public class WaveView extends View
{
	...
	{
		waveSpeed = (float) ScreenModule.dp2px(context, speed) / 60;
	}
	...
	{
		floatSpeed = (float) ScreenModule.dp2px(context, speed) / 60;
	}
	...
	public void startWaving()
	{
		...
		else
		{
			...
			timer.schedule(wavingTask, 0, 10);
			isWaving = true;
		}
	}
	...
	public void startFloating()
	{
		...
		else
		{
			...
			timer.schedule(floatingTask, 0, 10);
			isFloating = true;
		}
	}
